package biz.com.model;

/*
 *  VO : Value Object 클래스
 *  한 객체의(사람, 책, ...)의 데이터를 저장해서
 *  메소드간, 클래스간에 이동할 때 바구니처러
 *  사용하는 클래서
 *  
...
public class ScoreVO {
	 ...
	 *   	private으로 선언을 한다.
	 *  2. 멤버ㅏㅣ변수를 외부에서 접근(저장, 읽기)할 수 있도록
	 *  	getter와 setter 메서드를 생성해서 사용한다.
	 * 		== 데이터의 은닉(감추기)해서 데이터를 보호하는 목적
	 *  3. toString() 메소드를 재 정의(Override)해서
	 * 		필드에 저장된 값을 외부에서 확인할 수 있도록 한다. 
	 * 
	 */
	...
	// 이 method를 각 필드에 값을 확인시켜주는 ㅇ용도로 변경
	@Override
